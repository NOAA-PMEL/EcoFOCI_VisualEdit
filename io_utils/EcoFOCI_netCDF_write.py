...
class NetCDF_QCD_CTD(object):
    ...
    def file_create(self):
            rootgrpID = Dataset(self.savefile, NetCDF_QCD_CTD.nc_read, format=NetCDF_QCD_CTD.nc_format)
            self.rootgrpID = rootgrpID
            return ( rootgrpID )
    ...
    def add_data(self, data_dic=None):
        """ """
